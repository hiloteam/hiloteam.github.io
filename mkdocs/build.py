...
def build(config, live_server=False):
    ...
    utils.copy_media_files(config['theme_dir'], config['site_dir'], utils.html_extensions())
    utils.copy_media_files(config['docs_dir'], config['site_dir'], utils.markdown_extensions())
    build_pages(config)
